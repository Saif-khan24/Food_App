...
//     .get(protectRoute, isAuthorized(['admin', 'ce']), getbookings)          //localhost/user -> get

// bookingRouter
//     .route('/:id')
//     .get(getbooking)
//     .patch(bodyChecker,  isAuthorized(['admin', 'ce']), updatebooking)  //ce = customer executive
//     .delete(bodyChecker, isAuthorized(['admin']), deletebooking)
    
// async function getUsersAlso(req, res){
//     try{
//         let booking = await bookingModel.find().populate({       //populate ref ki help se chalta h
//             path: "user",
//             select: "name",         //for showing particular schemas
//         })
